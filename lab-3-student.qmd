...
<!-- Data types include categorical in the case of species, sex, day of week, genus, taxa; identifyers such as record id and plot id; ordinal such as month, day, year, and date; and numerical such as hindfoot length and wieght.  -->
...
ggplot(data = surveys,
  ...
  facet_grid(.~ species) + 
  labs(x = "weight", y = "", title = "weights and hindfoot length measurements split by species", subtitle = "hindfoot length")
```

***I used an external website to figure out how to facet: https://stackoverflow.com/questions/59848243/how-do-i-make-a-faceted-scatterplot-in-r
